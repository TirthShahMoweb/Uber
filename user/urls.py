...
from rest_framework_simplejwt.views import TokenRefreshView  # Refreshes access token
...
urlpatterns = [
    ...
    path(
        "driverPersonalDetailView/<int:id>",
        driverDetailsViews.DriverPersonalDetailsView.as_view(),
    ),
    ...
    path(
        "reachedPickUpLocationView/<int:id>",
        tripViews.ReachedPickUpLocationView.as_view(),
    ),
    path(
        "verifiedDriverAtPickUpLocationView/<int:id>",
        tripViews.VerifiedDriverAtPickUpLocationView.as_view(),
    ),
