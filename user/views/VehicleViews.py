...
# from ..models import Vehicle, driver_details
...
#         try:
#             driver = driver_details.objects.get(user=request.user)
#         except driver_details.DoesNotExist:
...
#         try:
#             driver = driver_details.objects.get(user=user)
#         except driver_details.DoesNotExist:
#             raise driver_details.DoesNotExist('Driver details not found')
