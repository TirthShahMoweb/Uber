...
class adminRightsView(RetrieveUpdateAPIView):
    ...
    def get_queryset(self):
        return User.objects.filter(
            verification_code=self.kwargs["verification_code"], user_type="admin"
        )
    ...
    def get(self, request, *args, **kwargs):
        ...
        return Response(
            {
                "status": "success",
                "message": "Successfully Rights given.",
                "data": data,
            },
            ...
            return Response(
                {
                    ...
                    "errors": {
                        "verification_code": "User not found with this verification code."
                    },
                },
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            permissions = Permission.objects.filter(
                permissions__in=role_permissions
            ).values_list("permission_name")
            ...
            return Response(
                {"status": "success", "message": "Successfully Login.", "data": data},
                status=status.HTTP_200_OK,
            )
...
class ResendOtpView(UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        data = {"mobile_number": user.mobile_number, "otp": new_otp}
        return Response(
            {"status": "success", "message": "Resend OTP successfully", "data": data},
            status=status.HTTP_200_OK,
        )
...
class SignupView(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response(
                {"status": "success", "message": "Signup successful", "data": data},
...
class ForgotPasswordView(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            data = {"email": user.email, "link": link}
            return Response(
                {
                    "status": "success",
                    "message": "Reset password link sent to your email. If Register.",
                    "data": data,
                },
                status=status.HTTP_200_OK,
            )
...
class ResetPasswordView(UpdateAPIView):
    ...
    def get_object(self):
        ...
        try:
            ...
            return Response(
                {
                    "status": "error",
                    "message": "User not found with this verification code.",
                },
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def update(self, request, *args, **kwargs):
        ...
        user = self.get_object()
        serializer = self.get_serializer(
            user, data=request.data, context={"verification_code": verification_code}
        )
        if serializer.is_valid():
            user = serializer.save()
...
class ListTeamMemberView(ListAPIView):
    ...
    def get_queryset(self):
        ...
        return (
            User.objects.filter(user_type="admin", deleted_at=None)
            .exclude(id=user.id)
            .annotate(
                name=Concat(
                    F("first_name"),
...
class UpdateTeamMemberView(RetrieveUpdateAPIView):
    ...
    def get_object(self):
        try:
            ...
            errors = {"user": "User not found."}
            raise NotFound(
                {"status": "error", "message": "Vallidation Error", "errors": errors}
            )
        if user.deleted_at:
            errors = {"user": "User not found."}
            raise NotFound(
...
class UpdateDriverLastOnlineAtView(UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
            ...
            return Response(
                {
                    ...
                    "errors": "This is only for Drivers",
                },
                status=status.HTTP_400_BAD_REQUEST,
            )
        ...
        driver.save()
        return Response(
            {"status": "success", "message": "Driver updated successfully"},
            status=status.HTTP_200_OK,
        )
