...
class Vehicle(BaseModel):
    ...
    verification_documents = models.ManyToManyField(
        "DocumentType", related_name="vehicle_approve_documents"
    )
...
class VehicleRequest(BaseModel):
    ...
    action_by = models.ForeignKey(
        ...
        related_name="vehicle_request_verifier",
        null=True,
        blank=True,
    )
    vehicle_number = models.CharField(max_length=10, unique=True)
    ...
    verification_documents = models.ManyToManyField(
        "DocumentType", related_name="vehicle_request_documents"
    )
...
class DocumentType(BaseModel):
    document_type = models.CharField(
        max_length=100
    )  # vehicle_front_image, vehicle_back_image, vehicle_leftSide_image, vehicle_rightSide_image, vehicle_rc_front_image, vehicle_rc_back_image
    document_image = models.ImageField(
        upload_to=unique_vehicle_images_path, null=True, blank=True
    )
