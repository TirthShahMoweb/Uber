...
urlpatterns = [
    ...
    path(
        "adminVehicleStatusListView", vehicleViews.AdminVehicleStatusListView.as_view()
    ),
    path(
        "driverVehicleDetailsView/<int:pk>",
        vehicleViews.DriverVehicleDetailsView.as_view(),
    ),
    path("vehicleListView", vehicleViews.VehicleListView.as_view()),
    path(
        "adminVehicleApprovalView/<int:pk>",
        vehicleViews.AdminVehicleApprovalView.as_view(),
    ),
